...
namespace MythicArcanist.NewContent.Spells
{
    static class MageArmor4
    {
        public static void AddMageArmor4()
        {
            ...
            Utilities.ItemTools.AddToVendor(MAContext, Scroll, 1, BlueprintSharedVendorTables.WarCamp_REVendorTableMagic);
            Utilities.ItemTools.AddToVendor(MAContext, Scroll, 2, BlueprintSharedVendorTables.Scroll_Chapter3VendorTable);
